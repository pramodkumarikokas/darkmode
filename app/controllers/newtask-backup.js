...
/*
var orderedByMonths = _.groupBy(usersByLikes, async function(element) {
  //console.log("date :: ",element)
                          return await element.date.substring(0,10);
                      });
            
var orderedByYears =  _.groupBy(orderedByMonths, async function(month) {
                         return await month[0].date.substring(0,10);
                      });
*/
